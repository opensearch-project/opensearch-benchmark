...
class Documents:
    ...
    def __init__(self, source_format, document_file=None, document_archive=None, base_url=None,
        ...
        contains documents.
        :param number_of_documents: The number of documents in the benchmark
         document. Needed for proper progress results_publishing. Only needed if
...
class Operation:
    ...
    def include_in_results_publishing(self):
        return self.params.get("include-in-results-publishing", True)
