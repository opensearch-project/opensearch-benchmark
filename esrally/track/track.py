...
class Documents:
    ...
    def __init__(self, source_format, document_file=None, document_archive=None, base_url=None,
        ...
        contains documents.
        :param number_of_documents: The number of documents in the benchmark document. Needed for publishing results. Only needed if
        ...
        :param compressed_size_in_bytes: The compressed size in bytes of the benchmark document. Needed for verification of the download and
         user publishing results. Only useful if a document_archive is given (optional but recommended to be set).
...
class Operation:
    ...
    @property
    def include_in_publishing_results(self):
        return self.params.get("include-in-publishing-results", True)
