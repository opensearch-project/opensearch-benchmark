...
def java_home(provision_config_runtime_jdks, specified_runtime_jdk=None, provides_bundled_jdk=False):
    ...
    try:
        allowed_runtime_jdks = [int(v) for v in provision_config_runtime_jdks.split(",")]
    except ValueError:
        raise exceptions.SystemSetupError(
            "Provision config key \"runtime.jdk\" is invalid: \"{}\" (must be int)".format(provision_config_runtime_jdks))
