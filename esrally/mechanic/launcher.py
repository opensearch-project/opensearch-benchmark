...
class ProcessLauncher:
    ...
    def _start_node(self, node_configuration, node_count_on_host):
        ...
        java_major_version, java_home = java_resolver.java_home(node_configuration.provision_config_runtime_jdks,
                                                                self.cfg.opts("mechanic", "runtime.jdk"),
                                                                node_configuration.provision_config_provides_bundled_jdk)
