...
class WorkloadTests(TestCase):
    def test_finds_default_challenge(self):
        default_challenge = workload.Challenge("default", description="default challenge", default=True)
        another_challenge = workload.Challenge("other", description="non-default challenge", default=False)
    ...
    def test_does_not_find_unknown_challenge(self):
        ...
        self.assertEqual("Unknown challenge [unknown-name] for workload [unittest]", ctx.exception.args[0])
