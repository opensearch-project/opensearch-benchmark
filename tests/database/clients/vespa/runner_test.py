...
from osbenchmark.database.clients.vespa.runners import (
    VespaBulkIndex,
    VespaVectorSearch,
...
class VespaBulkIndexRunnerTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.runners.transform_document_for_vespa")
    @mock.patch("osbenchmark.database.clients.vespa.runners.parse_bulk_body")
    @mock.patch("osbenchmark.database.clients.vespa.runners.PYVESPA_AVAILABLE", True)
    @mock.patch("osbenchmark.database.clients.vespa.runners.request_context_holder")
    @run_async
    ...
    @mock.patch("osbenchmark.database.clients.vespa.runners.transform_document_for_vespa")
    @mock.patch("osbenchmark.database.clients.vespa.runners.parse_bulk_body")
    @mock.patch("osbenchmark.database.clients.vespa.runners.PYVESPA_AVAILABLE", False)
    @mock.patch("osbenchmark.database.clients.vespa.runners.request_context_holder")
    @run_async
    ...
    @mock.patch("osbenchmark.database.clients.vespa.runners.transform_document_for_vespa", side_effect=lambda d: d)
    @mock.patch("osbenchmark.database.clients.vespa.runners.parse_bulk_body")
    @mock.patch("osbenchmark.database.clients.vespa.runners.PYVESPA_AVAILABLE", True)
    @mock.patch("osbenchmark.database.clients.vespa.runners.request_context_holder")
    @run_async
...
class VespaRunnerYqlContractTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.runners.convert_vespa_response")
    @mock.patch("osbenchmark.database.clients.vespa.runners.request_context_holder")
    @run_async
