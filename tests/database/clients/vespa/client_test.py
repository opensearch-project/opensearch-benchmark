...
"""
Unit tests for osbenchmark.database.clients.vespa.client
...
import osbenchmark.database.clients.vespa.client as vespa_mod
from osbenchmark.database.clients.vespa.client import (
    VespaClientFactory,
    VespaDatabaseClient,
)
...
class VespaClientFactoryTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.client.wait_for_vespa")
...
class VespaDatabaseClientSessionTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.client.aiohttp", create=True)
    @run_async
...
class VespaPyvespaSyncSessionTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.client.PYVESPA_AVAILABLE", True)
    @mock.patch("osbenchmark.database.clients.vespa.client.PyvespaApp")
    ...
    @mock.patch("osbenchmark.database.clients.vespa.client.PYVESPA_AVAILABLE", False)
...
class VespaIndexTests(TestCase):
    ...
    @mock.patch("osbenchmark.database.clients.vespa.client.requests")
    @run_async
